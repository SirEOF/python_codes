...
UMENG_ERROR = {
    ...
    '1005': 'imgurl格式不对，请以https或者http开始',
    '1006': 'soundurl格式不对，请以https或者http开始',
...
class UMengException(Exception):

    def __init__(self, code_or_msg):
        message = UMENG_ERROR.get(str(code_or_msg), str(code_or_msg))
        super(UMengException, self).__init__(message)
