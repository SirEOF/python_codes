...
from netdicom.DULprovider import DULServiceProvider, MaximumLengthParameters
...
def monkey_patch_netdicom():
    ...
    修正:
        ...
        3. pynetdicom不支持XRayImageStorageSOPClass问题
    """
    netdicom.ACSEprovider.ACSEServiceProvider.Accept = ACSEServiceProvider.Accept
    netdicom.ACSEprovider.ACSEServiceProvider.__init__ = ACSEServiceProvider.__init__
